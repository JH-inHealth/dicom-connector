...
public class MoveScu {
    ...
    private MoveScu(MuleDimseRSPHandler handler) {
    ...
    public static MoveScu execute(ScuConnection connection, ScuOperationConfig scuOperationConfig, Map<String, Object> searchKeys) {
        Attributes keys = AttribUtils.toKeys(searchKeys);
        // Add retrieve level to the query
        ...
        try {
            ...
            log.info("{}: C-MOVE {}", connection, searchKeys);
